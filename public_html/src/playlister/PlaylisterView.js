...
export default class PlaylisterView {
  ...
  refreshPlaylist(playlist) {
    ...
    for (let i = 0; i < playlist.songs.length; i++) {
      ...
      let itemHyperlink = document.createElement("a");
      itemHyperlink.setAttribute(
        "href",
      ...
      let itemNumber = document.createTextNode(i + 1 + ". ");

      itemHyperlink.appendChild(itemText);

      itemDiv.appendChild(itemNumber);
      itemDiv.appendChild(itemHyperlink);
