...
export default class PlaylisterController {
  ...
  initModalHandlers() {
    ...
    editSongConfirmButton.onclick = (event) => {
      ...
      let editSongYouTubeId = document.getElementById(
        "edit-song-youTubeId"
      ).value;
  ...
  registerItemHandlers() {
    ...
    for (let i = 0; i < this.model.getPlaylistSize(); i++) {
      ...
      card.ondblclick = (event) => {
        ...
        let currentSong = this.model.currentList.songs[i];
        let editSongTitle = document.getElementById("edit-song-title");
        let editSongArtist = document.getElementById("edit-song-artist");
        let editSongYouTubeId = document.getElementById("edit-song-youTubeId");

        editSongTitle.value = currentSong.title;
        editSongArtist.value = currentSong.artist;
        editSongYouTubeId.value = currentSong.youTubeId;
